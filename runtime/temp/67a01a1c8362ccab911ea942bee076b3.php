<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"C:\xampp\htdocs\appFactory\public/../application/admin\view\login\login.html";i:1556019690;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="logobox">
                    <p class="text-center">appFactory</p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->
