            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                <th class="text-center" width="5%">appid</th>
                                <th class="text-center">app名称</th>
                                <th class="text-center">安装链接</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $vo['appName']; ?></td>
                                <td align="center"><?php echo $vo['url_short']; ?></td>
                                <td align="center"><?php echo date("Y-m-d H:i:s",$vo['time']); ?></td>
                                <td align="center"><?php echo date("Y-m-d H:i:s",$vo['deadline']); ?></td>
                                <td align="center">
                                        <?php echo $vo['user']['uname']; ?>
                                </td>
                                <td align="center">
                                    <!-- <a href="<?php echo url('article/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a> -->
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('applist/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
