<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\xampp\htdocs\appFactory\public/../application/admin\view\login\login.htm";i:1495182960;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml"><!--Head--><head>
    <meta charset="utf-8">
    <title>素材火ThinkPHP交流群：35291327</title>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="logobox">
                    <p class="text-center">素材火ThinkPHP交流群：352913274</p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->
