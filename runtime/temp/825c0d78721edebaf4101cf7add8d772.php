<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\xampp\htdocs\appFactory\public/../application/admin\view\orderlist\lst.html";i:1556261480;s:75:"C:\xampp\htdocs\appFactory\public/../application/admin\view\common\top.html";i:1556263264;s:76:"C:\xampp\htdocs\appFactory\public/../application/admin\view\common\left.html";i:1556259090;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                <th class="text-center" width="4%">订单号</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $vo['totalPrice']; ?></td>
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('orderlist/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
