<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\xampp\htdocs\appFactory\public/../application/index\view\userorderlist\index.html";i:1557474285;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
      ...
      <tbody>
        ...
        <tr class="danger">
         ...
         <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr class="active">
                <td class="appId"><?php echo $vo['proName']; ?></td>
                <td><?php echo $vo['appName']; ?></td>
                <td>¥<?php echo $vo['totalPrice']; ?></td>
                <td><?php echo !empty($vo['status'])?'<span class="label label-success">已付款</span>':'<span class="label label-danger">未付款</span>'; ?></td>
